...
import io.github.lxgaming.clearlag.commands.item.ItemAddCommand;
import io.github.lxgaming.clearlag.commands.item.ItemListCommand;
import io.github.lxgaming.clearlag.commands.item.ItemRemoveCommand;
import io.github.lxgaming.clearlag.commands.item.ItemValidateCommand;
...
public class ItemCommand extends Command {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		textBuilder.append(Text.of(TextColors.DARK_GREEN, "Item sub commands:"));
